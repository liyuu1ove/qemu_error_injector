...
/* Optional ADD corruption controls (default: off, enable via QEMU_INJECT_ADD). */
static bool inject_add_corruption;
static uint64_t inject_add_every = 1;
static uint64_t inject_add_counter;
